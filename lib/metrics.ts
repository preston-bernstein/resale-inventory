...
// internal-infra repo, a separate deploy). Given that, the safer, fully
...
// (`<docker-root>/observability/node-exporter-textfiles/`) plus the
// corresponding Prometheus alert rule is a internal-infra-side, deploy-time
