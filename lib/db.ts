...
// internal-inventory-app-change-control §4.3.
//
...
const VERSIONED_MIGRATIONS = [
  ...
  { version: 14, file: '014_electronics_category.sql' },
];
...
// table-rebuild pattern (section 4 of internal-inventory-app-change-control) when
