// "Similar words" search expansion, ported from the internal-scraper-service project's
...
//
// internal-scraper-service's version additionally implied a taxonomy category from the
