...
| Fact | Re-verify with |
|---|---|
| Git history is real; private remote `preston-bernstein/internal-inventory-app` (note: GitHub repo and npm package name were both renamed from `book-seller`; the on-disk folder path is unchanged) | `cd /Users/prestonbernstein/dev/book-seller && git log --oneline 2>&1 \| tail -1 && git remote -v` |
