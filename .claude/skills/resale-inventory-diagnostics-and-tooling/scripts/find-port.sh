#!/bin/bash
# find-port.sh — locate the port actually serving the internal-inventory-app app.
...
echo "internal-inventory-app not found on ports 3000-3010 (is the server running? npm run dev)" >&2
exit 1
