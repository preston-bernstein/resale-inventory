...
### Task 24: Fix DR-3 (ISBN lookup collapses every failure to 404; plan says 503)
**Status**: [x] done (2026-07-03)
...
**Depends on**: none
**Parallelizable**: yes
**Notes**: Closes DR-3. failure-archaeology DR-3 and the architecture-contract "Other recorded spec-vs-code drift" note flipped to FIXED citing this task. Renumbered to 24 to follow Task 23 (DR-1), the latest committed task on main at branch time.
