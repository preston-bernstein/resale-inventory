...
-- Table-rebuild migration per internal-inventory-app-change-control §4 and the DR-7 precedent
...
**Migration mechanics precisely, per `internal-inventory-app-change-control` §4:**
