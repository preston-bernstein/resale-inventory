...
- Must not modify `data/inventory.db` directly and must not delete/recreate it, per the repo's sacred-DB rules documented in `.claude/skills/internal-inventory-app-run-and-operate/SKILL.md`.
